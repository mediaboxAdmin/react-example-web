...
const EditArticlePage = () => {
   ...
   const handleSubmit = async (e) => {
      try {
         ...
         await fetchApi(`/article/update/${ID_ARTICLE}`, {
            method: "PUT",
            body: form,
         })
               ...
               <div className="form-group col-sm">
                  <div className="row">
                     <div className="col-md-4">
                        <label htmlFor="NAME_ARTICLE" className="label mb-1">
                           Article
                        </label>
                     </div>
                     <div className="col-sm">
                        <InputText
                           ...
                           id="NAME_ARTICLE"
                           name="NAME_ARTICLE"
                           value={data.NAME_ARTICLE}
                           onChange={handleChange}
                           onBlur={checkFieldData}
                           className={`w-100 is-invalid ${hasError("NAME_ARTICLE") ? "p-invalid" : ""}`}
                        />
