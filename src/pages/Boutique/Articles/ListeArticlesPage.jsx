...
const ListeArticlesPage = () => {
  ...
  const deleteItems = async (itemsIds) => {
    try {
      ...
      await fetchApi("/article/delete", {
        method: 'POST',
        body: form
      })
      dispacth(setToastAction({ severity: 'success', summary: 'Article supprimé', detail: "L'article a été supprimé avec succès", life: 3000 }))
    ...
    <>
      ...
      <div className="px-4 py-3 main_content">
        <div className="d-flex align-items-center justify-content-between">
          ...
          <Button label="Nouveau article" icon="pi pi-plus" size="small" onClick={() => {
...
export default ListeArticlesPage